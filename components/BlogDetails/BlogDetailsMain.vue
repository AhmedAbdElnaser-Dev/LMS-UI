            ...
            <div class="row">
               <div class="col-xl-12">
                  <div class="hero-course-1-text">
                     <h2>How to teach web design to the new students</h2>
                  </div>
                  <div class="course-title-breadcrumb">
                     <nav>
                        <ol class="breadcrumb">
                           ...
                           <li class="breadcrumb-item"><span>How to teach web design to the new students</span></li>
                        </ol>
                     </nav>
                  </div>
               </div>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12">
                           <div class="blog-wrapper position-relative blog-details-wrapper mb-30">
                              <div class="blog-thumb ">
                                 <img src="/img/blog/blog-01.jpg" alt="blog-img">
                              </div>
                              <div class="blog-tag">
                                 <i class="fal fa-folder-open"></i>
                                 <NuxtLink to="/blog">Development</NuxtLink>
                              </div>
                              <div class="blog-content-wrapper">
                                 ...
                                 <div class="blog-content">
                                    ...
                                    <blockquote>
                                       ...
                                       <p class="mb-0"><cite>Eduman</cite></p>
                                    </blockquote>
                                    ...
                                    <p><img src="/img/blog/blog-04.jpg" alt="img"></p>
                                    <h4 class="mb-20">Typography is the powerful element you will ever need</h4>
                                    ...
                                    <div class="blog__details__tag tagcloud"><span>Post Tags : </span>
                                       <NuxtLink to="/blog">Class</NuxtLink>
                                       <NuxtLink to="/blog">Course</NuxtLink>
                                       <NuxtLink to="/blog">Design</NuxtLink>
                                       <NuxtLink to="/blog">Science</NuxtLink>
                                    </div>
                                 </div>
                              </div>
                              <div class="latest-comments mb-50 mt-50">
                                 <h3>3 Comments</h3>
                                 <ul>
                                    <li>
                                       <div class="comments-box">
                                          <div class="comments-info d-flex">
                                             <div class="comments-avatar mr-20">
                                                <img src="/img/member/member-img-04.png" alt="img not found">
                                             </div>
                                    ...
                                    <li class="children">
                                       <div class="comments-box">
                                          <div class="comments-info d-flex">
                                             <div class="comments-avatar mr-20">
                                                <img src="/img/member/member-img-01.png" alt="img not found">
                                             </div>
                                             <div class="avatar-name">
                                                <h5>Dominic</h5>
                                       ...
                                       <ul>
                                          <li class="children-2">
                                             <div class="comments-box">
                                                <div class="comments-info d-flex">
                                                   <div class="comments-avatar mr-20">
                                                      <img src="/img/member/member-img-02.png" alt="img not found">
                                                   </div>
                                                   <div class="avatar-name">
                                                      <h5>Von Rails</h5>
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-xxl-12">
                                          <div class="blog__comment-btn">
                                             <button type="submit" class="edu-btn">Post Comment</button>
                                          </div>
                                       </div>
                                    </div>
                                 </form>
