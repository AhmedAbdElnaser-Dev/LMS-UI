    ...
    <div>
        ...
        <header>
            <div class="university-header-wrapper">
                ...
                <div
                    :class="`${isSticky ? 'header-main3 transpaerent-header sticky-header sticky' : 'header-main3 transpaerent-header sticky-header'}`">
                    <div class="container">
                        <div class="header-main-wrapper">
                            <div class="row align-items-center">
                                <div class="col-xl-2 col-lg-2 col-md-3 col-sm-3 col-3">
                                    <div class="header-logo">
                                        <NuxtLink to="/"><img class="logo-white" src="/img/logo/logo-white.png"
                                                alt="logo"></NuxtLink>
                                        <NuxtLink to="/"><img class="logo-black" src="/img/logo/logo-black.png"
                                                alt="logo"></NuxtLink>
                                    </div>
                                </div>
                                <div class="col-xl-10 col-lg-10 col-md-9 col-sm-9 col-9">
                                    <div class="header-main-right d-flex justify-content-end">
                                        ...
                                        <div class="header-btn">
                                            ...
                                            <NuxtLink to="/signup" class="edu-thard-btn d-none d-lg-block">Enroll now</NuxtLink>
