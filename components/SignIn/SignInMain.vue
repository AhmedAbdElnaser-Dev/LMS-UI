                                    ...
                                    <div class="signup-form-wrapper">
                                        <div class="signup-wrapper">
                                            <input type="text" v-model="formData.email"
                                                :placeholder="$t('EmailOrUsername')" required />
                                        </div>
                                        <div class="signup-wrapper">
                                        ...
                                        <div class="sing-buttom mb-20">
                                            <button type="submit" class="sing-btn" :disabled="loading">
                                                {{ loading ? $t('Loading...') : $t('SignInNow') }}
                                            </button>
                                        </div>
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="21.692" height="16.273"
                                                    ...
                                                    <g id="gmail" transform="translate(0 -63.953)">
                                                        ...
                                                        <path id="Path_8687" data-name="Path 8687"
                                                            d="M349.816,65.436L347.789,69.3l2.027,2.541l4.93-3.7V66.176A2.219,2.219,0,0,0,351.2,64.4Z"
