...
<template>
  <div class="student-course-area pt-110 pb-90">
    <div class="container">
      <div class="row">
        <div class="col-xl-4 col-lg-5">
          <div class="section-title mb-55">
            <h2>
              Pick Your <br />
              <span class="down-mark-line-2">Professional</span> Course
            </h2>
          </div>
        </div>
            ...
            <nav>
              <div class="nav" id="nav-tab" role="tablist">
                <button
                  ...
                  aria-selected="true"
                >
                  View All <span class="port-red">[08]</span>
                </button>
                <button
                  class="nav-link"
                  id="nav-profile-tab"
                  ...
                  aria-selected="false"
                >
                  Data Science <span class="port-red">[04]</span>
                </button>
                <button
                  class="nav-link"
                  id="nav-contact-tab"
                  ...
                  aria-selected="false"
                >
                  Development <span class="port-red">[02]</span>
                </button>
                <button
                  class="nav-link"
                  id="nav-contact-tabA"
                  ...
                  aria-selected="false"
                >
                  Business <span class="port-red">[01]</span>
                </button>
                <button
                  class="nav-link"
                  id="nav-contact-tabB"
                  ...
                  aria-selected="false"
                >
                  Life Styles <span class="port-red">[01]</span>
                </button>
              </div>
            </nav>
          </div>
        ...
        <div class="tab-content" id="nav-tabContent">
          ...
          >
            <div class="row">
              <div
                ...
                v-for="item in courseItemss.slice(0, 8)"
                :key="item.id"
              >
                <div class="course-wrapper-2 mb-30">
                  <div class="student-course-img">
                    <img :src="item.courseImage" alt="courde-img" />
                  </div>
                    ...
                    <div class="course-info-wrapper">
                      <div class="cart-info-body">
                        ...
                        <div class="cart-lavel">
                          <h5>
                            {{ item.level }} <span>{{ item.beginer }}</span>
                          </h5>
                        ...
                        <div class="info-cart-text">
                          <ul>
                            <li
                              v-for="itemTwo in item.infoList"
          ...
          >
            <div class="row">
              <div
                class="col-xl-3 col-lg-4 col-md-6"
                v-for="item in courseItemss.slice(0, 4)"
                :key="item.id"
              >
                <div class="course-wrapper-2 mb-30">
                  <div class="student-course-img">
          ...
          >
            <div class="row">
              <div
                class="col-xl-3 col-lg-4 col-md-6"
                v-for="item in courseItemss.slice(4, 6)"
                :key="item.id"
              >
                <div class="course-wrapper-2 mb-30">
                  <div class="student-course-img">
          ...
          >
            <div class="row">
              <div
                class="col-xl-3 col-lg-4 col-md-6"
                v-for="item in courseItemss.slice(5, 8)"
                :key="item.id"
              >
                <div class="course-wrapper-2 mb-30">
                  <div class="student-course-img">
          ...
          >
            <div class="row">
              <div
                class="col-xl-3 col-lg-4 col-md-6"
                v-for="item in courseItemss.slice(7, 8)"
                :key="item.id"
              >
                <div class="course-wrapper-2 mb-30">
                  <div class="student-course-img">
      ...
      <div class="row justify-content-center">
        <div class="col-xl-3">
          <div class="portfolio-brn mt-20 text-center">
            <NuxtLink class="edu-sec-btn" to="/course"
              >View all courses</NuxtLink
            >
          </div>
        </div>
      </div>
