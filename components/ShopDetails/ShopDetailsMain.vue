...
import RelatedSlider from "./RelatedSlider.vue";
                  ...
                  <div class="course-title-breadcrumb">
                     <nav>
                        <ol class="breadcrumb">
                           ...
                           <li class="breadcrumb-item"><span>Shop details</span></li>
                        </ol>
                     </nav>
                  </div>
               </div>
            ...
            <div class="row ">
               <div class="col-lg-4 col-md-12">
                  <div class="product-details-img mb-30">
                     <img src="/img/products/product-thumb-10.png" alt="product img">
                  </div>
               </div>
               <div class="col-lg-6 col-md-12">
                  <div class="product-side-info mb-30">
                     <h4 class="product-name mb-10">The Almanack</h4>
