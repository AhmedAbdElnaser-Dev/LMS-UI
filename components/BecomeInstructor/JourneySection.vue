                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-lg-6">
                                        <div class="step-journey-thumb d-flex-align-items-center">
                                            <img src="/img/bg/step-journey-1.png" alt="step-journey">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            <div class="step-tab-content pt-60 mb-30">
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-lg-6">
                                        <div class="step-journey-thumb d-flex-align-items-center">
                                            <img src="/img/bg/step-journey-2.png" alt="step-journey">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                            <div class="step-tab-content pt-60 mb-30">
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-lg-6">
                                        <div class="step-journey-thumb d-flex-align-items-center">
                                            <img src="/img/bg/step-journey-3.png" alt="step-journey">
                                        </div>
                                    </div>
                                </div>
                            </div>
