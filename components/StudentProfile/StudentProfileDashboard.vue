            ...
            <div class="col-lg-12">
                ...
                <div class="inprogress-course mb-30">
                    <div class="inprogress-course-img">
                        <NuxtLink to="/course"><img src="/img/blog/blog-01.jpg" alt="img not found" /></NuxtLink>
                    </div>
                    <div class="inprogress-course-text">
                        ...
                        <h4 class='inprogress-course-title'>
                            <NuxtLink to="/course">WordPress Development Course for Plugins and
                                Themes</NuxtLink>
                        </h4>
                ...
                <div class="inprogress-course mb-30">
                    <div class="inprogress-course-img">
                        <NuxtLink to="/course"><img src="/img/blog/blog-02.jpg" alt="img not found" /></NuxtLink>
                    </div>
                    <div class="inprogress-course-text">
                        <div class="inprogress-course-rating">
                            <a href="#"><i class="fas fa-star"></i></a>
                        ...
                        <h4 class='inprogress-course-title'>
                            <NuxtLink to="/course">Data Science Real-Life Data Science Exercises
                                Included</NuxtLink>
                        </h4>
                        <div class="inprogress-course-lesson mb-15">
                            <span>Completed Lessons :</span>
